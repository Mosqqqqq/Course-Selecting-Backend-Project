# coding: utf-8
from sqlalchemy import CHAR, Column, DateTime, Float, ForeignKey, ForeignKeyConstraint, Index, Integer
...
class SelectedCourseNow(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['course_id', 'semester', 'staff_id', 'class_time'], ['available_course.course_id', 'available_course.semester', 'available_course.staff_id', 'available_course.class_time'], onupdate='CASCADE'),
