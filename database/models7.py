...
class Root(Base):
    ...
    root_id = Column(CHAR(60), primary_key=True)
...
class AvailableCourse(Base):
    ...
    course_id = Column(ForeignKey('all_course.course_id', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True,
                       nullable=False, index=True)
    semester = Column(CHAR(60), primary_key=True, nullable=False)
    staff_id = Column(ForeignKey('staff.staff_id', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True,
                      nullable=False, index=True)
...
class EndedCourse(Base):
    ...
    student_id = Column(ForeignKey('student.student_id', onupdate='CASCADE'), primary_key=True, nullable=False,
                        index=True)
    semester = Column(CHAR(60), primary_key=True, nullable=False)
...
class SelectedCourseNow(Base):
    ...
    student_id = Column(ForeignKey('student.student_id', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True,
                        nullable=False, index=True)
    semester = Column(CHAR(60), primary_key=True, nullable=False)
