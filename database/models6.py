...
class AvailableCourse(Base):
    ...
    course_id = Column(ForeignKey('all_course.course_id', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True, nullable=False, index=True)
    semester = Column(CHAR(60), primary_key=True, nullable=False)
    staff_id = Column(ForeignKey('staff.staff_id', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True, nullable=False, index=True)
...
class Clas(Base):
    ...
    dept_id = Column(ForeignKey('dept.dept_id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True)
    major_id = Column(ForeignKey('major.major_id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True)
...
class Student(Base):
    ...
    gpa_this = Column(Float)
    gpa_total = Column(Float)
    pwd = Column(Text, nullable=False)
...
class EndedCourse(Base):
    ...
    student_id = Column(ForeignKey('student.student_id', onupdate='CASCADE'), primary_key=True, nullable=False, index=True)
    semester = Column(CHAR(60), primary_key=True, nullable=False)
    course_id = Column(ForeignKey('all_course.course_id', onupdate='CASCADE'), primary_key=True, nullable=False, index=True)
...
class SelectedCourseNow(Base):
    ...
    student_id = Column(ForeignKey('student.student_id', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True, nullable=False, index=True)
    semester = Column(CHAR(60), primary_key=True, nullable=False)
    course_id = Column(CHAR(60), primary_key=True, nullable=False, index=True)
    staff_id = Column(ForeignKey('staff.staff_id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True)
